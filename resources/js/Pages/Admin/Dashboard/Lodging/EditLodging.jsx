...
function EditLodging({ lodging, lodging_attributs, categories }) {
    const {
        ...
        name: lodging.name,
        type_lodging_id: lodging.type ? lodging.type.id : null,
        real_city_id: lodging.real_city ? lodging.real_city.id : null,
        link_city_id: lodging.linked_city ? lodging.linked_city.id : null,
        description: lodging.description,
        address1: lodging.address_1,
        address2: lodging.address_2,
        email: lodging.email,
        phone: lodging.phone,
        check_in: lodging.check_in,
        check_out: lodging.check_out,
        attributs: lodging_attributs,
        star_rating: lodging.star_rating || 1,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (validateForm()) {
            post(route("lodging.edit", { lodging_id: lodging.id }), {
                preserveScroll: true,
                onError: () =>
                                    ...
                                    <div className="grid grid-cols-2 gap-12">
                                        ...
                                        <div>
                                            <EditableDynamicSelect
                                                ...
                                                placeholder="Sélectionner une option"
                                                defaultOption={{
                                                    value: lodging.real_city.id,
                                                    label: lodging.real_city
                                                        .name,
                                                }}
                                            />
                                        </div>
                                        ...
                                        <div>
                                            <EditableDynamicSelect
                                                ...
                                                placeholder="Sélectionner une option"
                                                defaultOption={{
                                                    value: lodging.linked_city
                                                        .id,
                                                    label: lodging.linked_city
                                                        .name,
                                                }}
                                            />
                                        </div>
                                                            ...
                                                            >
                                                                <div className="flex items-center me-4">
                                                                    <input
                                                                        ...
                                                                        checked={data.attributs.includes(
                                                                            attribut.id
                                                                        )}
                                                                    />
                                                                    <label
...
EditLodging.layout = (page) => <AdminDashboardLayout children={page} />;
